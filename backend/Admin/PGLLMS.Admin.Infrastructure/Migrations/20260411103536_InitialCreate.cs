    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attachments_Lesson_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonTranslation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonTranslation_Lesson_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lesson",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonVersion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonVersion_Lesson_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lesson",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonVersionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chapters_Chapters_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Chapters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Chapters_CourseVersions_CourseVersionId",
                        column: x => x.CourseVersionId,
                        principalTable: "CourseVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Chapters_LessonVersion_LessonVersionId",
                        column: x => x.LessonVersionId,
                        principalTable: "LessonVersion",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudySessions_Chapters_ChapterId",
                        column: x => x.ChapterId,
                        principalTable: "Chapters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionAnswerOptions", x => new { x.QuestionAnswerId, x.QuestionOptionId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionAnswerOptions_QuestionOptions_QuestionOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chapters_CourseVersionId_ParentId_Order",
                table: "Chapters",
                columns: new[] { "CourseVersionId", "ParentId", "Order" });

            migrationBuilder.CreateIndex(
                name: "IX_Chapters_LessonVersionId",
                table: "Chapters",
                column: "LessonVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_Chapters_ParentId",
                table: "Chapters",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_ChapterTranslations_ChapterId_LanguageCode",
                table: "ChapterTranslations",
                columns: new[] { "ChapterId", "LanguageCode" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseVersions_CourseId_IsPublished",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonTranslation_LessonId_LanguageCode",
                table: "LessonTranslation",
                columns: new[] { "LessonId", "LanguageCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LessonVersion_LessonId_IsPublished",
                table: "LessonVersion",
                columns: new[] { "LessonId", "IsPublished" },
                unique: true,
                filter: "[IsPublished] = 1");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionAnswerOptions_QuestionOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudySessions_UserId_ChapterId",
                table: "StudySessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserChapterProgresses_UserId_ChapterId",
                table: "UserChapterProgresses",
                columns: new[] { "UserId", "ChapterId" },
                unique: true);
        }
